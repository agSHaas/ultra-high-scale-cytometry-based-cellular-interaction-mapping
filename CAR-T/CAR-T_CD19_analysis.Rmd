...
list <- lapply(files, function(csv) {
  ...
  tab <- tab %>% 
    ...
    mutate(condition = if_else(str_detect(sample, "Bcells"), true = "control", false = "CAR"))
  return(tab)
})
