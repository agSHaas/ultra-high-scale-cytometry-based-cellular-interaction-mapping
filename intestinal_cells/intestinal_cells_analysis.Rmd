...
# plot singlet object 
```{r}
# obj_clean <- readRDS(paste0(data.dir, "obj_sketched_subclustered_projected_annotated_filtered.rds"))
...
dbts_obj@meta.data <- mutate(dbts_obj@meta.data, doublet_type = case_when(
  ...
  FACS_snn_res.2 == "14"~ "ISC*CD8+ TCRab+ T cells", # subcluster 
  FACS_snn_res.2 == "15"~ "TCRab*TCRgd",
  FACS_snn_res.2 == "16"~ "Ep*CD8+ TCRgd+ T cells",
  FACS_snn_res.2 == "17"~ "Ep*CD8+ TCRgd+ T cells", # subcluster? 
...
# only markers that have been used during singlet anno -------------
