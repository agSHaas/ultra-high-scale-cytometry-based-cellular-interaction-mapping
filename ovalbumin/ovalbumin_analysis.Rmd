...
# check FSC.H vs FSC.A in dotplot 
ggplot(ova@meta.data, aes(x = FSC.A , y = FSC.H, color = ratio_anno)) + geom_point() 
...
# repeat workflow 
n_dims <- Features(ova_clean) %>% length() # 20 Features
...
# check FSC.H vs FSC.A in dotplot 
ggplot(ova_clean@meta.data, aes(x = FSC.A , y = FSC.H, color = ratio_anno)) + geom_point() 
